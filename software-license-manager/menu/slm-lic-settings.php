...
function wp_lic_mgr_general_settings() {
    ...
    ?>
    <div class="alert alert-light"><p>For information, updates and documentation, please visit the <a href="https://www.tipsandtricks-hq.com/software-license-manager-plugin-for-wordpress" target="_blank">License Manager Documentation</a> page.</p></div>
            ...
            <div class="inside">
                <table class="form-table">
                    ...
                    <tr valign="top">
                        ...
                        <td><input class="form-control form-control-lg" type="text" name="lic_creation_secret" value="<?php echo $secret_key; ?>" size="40" />
                    ...
                    <tr valign="top">
                        ...
                        <td><input class="form-control form-control-lg" type="text" name="lic_verification_secret" value="<?php echo $secret_verification_key; ?>" size="40" />
                    ...
                    <tr valign="top">
                        ...
                        <td><input class="form-control form-control-lg" type="text" name="lic_prefix" value="<?php echo $options['lic_prefix']; ?>" size="40" />
                    ...
                    <tr valign="top">
                        ...
                        <td><input class="form-control form-control-lg" type="text" name="default_max_domains" value="<?php echo $options['default_max_domains']; ?>" size="6" />
                    ...
                    <tr valign="top">
                        ...
                        <td><input class="form-control form-control-lg" name="enable_auto_key_expiry" type="checkbox"<?php if (isset($options['enable_auto_key_expiry']) && $options['enable_auto_key_expiry'] != '') echo ' checked="checked"'; ?> value="1"/>                            
            ...
            <div class="inside">
                <table class="form-table">
                    ...
                    <tr valign="top">
                        ...
                        <td><input class="form-control form-control-lg" name="enable_debug" type="checkbox"<?php if ($options['enable_debug'] != '') echo ' checked="checked"'; ?> value="1"/>                            
