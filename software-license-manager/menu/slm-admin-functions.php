    ...
    <div class="postbox">
        ...
        <div class="inside">
            ...
            <form method="post" action="">
                ...
                <input class="form-control form-control-lg" name="lic_mgr_deactivation_req_url" type="text" size="100" value="<?php isset($_POST['lic_mgr_deactivation_req_url']) ? $_POST['lic_mgr_deactivation_req_url'] : ''; ?>"/>
                <div class="submit">
                    <input type="submit" name="send_deactivation_request" value="Send Request" class="btn btn-lg btn-primary" style="width:100% !important;" />
                </div>
            </form>
        </div></div>    
    <?php
