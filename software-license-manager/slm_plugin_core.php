...
function load_bootstrap_slm() {
	wp_enqueue_style('bootstrap_css_fix', WP_PLUGIN_URL . '/software-license-manager/bootstrap/css/bootstrap.css');
	wp_enqueue_style('tooltips', WP_PLUGIN_URL . '/software-license-manager/bootstrap/css/tooltips.css');
	//wp_enqueue_style('bootstrap_css','https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css');
	wp_enqueue_style('bootswatch', WP_PLUGIN_URL . '/software-license-manager/bootstrap/css/bootswatch.css');
...
add_action( 'admin_enqueue_scripts', 'load_bootstrap_slm' );
